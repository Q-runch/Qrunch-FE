...
const UploadBox: React.FC = () => {
  ...
  return (
    <label
      className={`flex flex-col justify-center items-center cursor-pointer w-full h-[80vh] m-auto  p-[70px] ${
        isActive ? ' active' : ''
      } `}
    ...
    >
      ...
      {!uploadedInfo && (
        <>
          ...
          <span className="font-medium text-[20px] my-5 mb-3">PDF 파일을 올려주세요</span>
        </>
      )}
    </label>
  );
